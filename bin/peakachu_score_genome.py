...
def parse_args(args=None):
    ...
    parser.add_argument('-p', '--path',
                    help = 'Path to a .cool URI string or file.')
    ...
    parser.add_argument('-l', '--lower', type = int, default=6, help = '''Lower bound of distance between loci in bins (default 6).''')
    parser.add_argument('-u', '--upper', type = int, default=300, help = '''Upper bound of distance between loci in bins (default 300).''')
    parser.add_argument('--minimum-prob', type = float, default=0.5, help = '''Only output pixels with probability score greater than this value (default 0.5)''')
